...
},{"core-js-pure/stable/instance/find":"ou1i"}],"zkPG":[function(require,module,exports) {
$(document).ready(function(){var s=10;$("div.card").click(function(a){a.preventDefault();var d=!1;$(this).hasClass("show")&&(d=!0),$("div.cards").hasClass("showing")?($("div.card.show").removeClass("show"),d?$("div.cards").removeClass("showing"):$(this).css({zIndex:s}).addClass("show"),s++):($("div.cards").addClass("showing"),$(this).css({zIndex:s}).addClass("show"),s++)})});
},{}],"FVon":[function(require,module,exports) {
"use strict";var e=o(require("@babel/runtime-corejs3/core-js-stable/instance/find"));function o(e){return e&&e.__esModule?e:{default:e}}var t=document.querySelector("nav"),n=document.querySelector("navbar-collapse"),a=document.getElementById("burger"),l=document.getElementById("shadow");window.onscroll=function(){window.scrollY>50?t.classList.add("bg-white"):t.classList.remove("bg-white")},a.onclick=function(){$(".navbar-collapse").hasClass("show")?$(window).scrollTop()<50&&$(".navbar").removeClass("bg-white"):$(".navbar").addClass("bg-white")},$(window).load(function(){$(".post-module").hover(function(){var o;(0,e.default)(o=$(this)).call(o,".description").stop().animate({height:"toggle",opacity:"toggle"},300)})});
},{"@babel/runtime-corejs3/core-js-stable/instance/find":"CoUx"}],"gJF1":[function(require,module,exports) {
module.exports="\t\n\v\f\r                　\u2028\u2029\ufeff";
...
"use strict";var t=o(require("@babel/runtime-corejs3/core-js-stable/parse-int")),e=o(require("@babel/runtime-corejs3/core-js-stable/instance/find"));function o(t){return t&&t.__esModule?t:{default:t}}var r=$(".js-card"),a=$(".js-card-grid");function n(t){var o=$("#card"+t);return'<div id="content'+t+'" data-id="'+t+'" class="more-container js-generated-content">'+(0,e.default)(o).call(o,".js-more-container").clone().html()+"</div>"}function c(t){var e=!1;r.each(function(){var o=$(this).position().top;if(o===t&&!1===e)r.removeClass("currentRow"),$(this).addClass("currentRow");else if(o>t&&!1===e)e=!0;else if(!0===e)return!1})}function s(){$(".js-generated-content").remove(),r.removeClass("active"),r.removeClass("currentRow")}a.on("click",".js-card",function(t){var e=$(".card.active"),o=0,r=$("body").scrollTop();e.length&&(o=e.position().top),s();var a=$(t.currentTarget),i=a.attr("data-id"),l=a.position().top;a.addClass("active"),c(l),$(".currentRow").after(n(i)),o!=l?$("html, body").animate({scrollTop:$("#content"+i).offset().top-50},500):$("body").scrollTop(r)}),a.on("click",".js-close-content",function(t){s();var e=$(t.currentTarget).closest(".js-generated-content").attr("data-id");$("#card"+e).removeClass("lastClick"),$("html, body").animate({scrollTop:$("#card"+e).offset().top-50},500)}),a.on("click",".js-next-content",function(e){var o,r=$(e.currentTarget).closest(".js-generated-content"),a=(0,t.default)(r.attr("data-id"))+1,i=$("#card"+a);if(i.length){var l=$(".card.active"),d=0,u=$("body").scrollTop();l.length&&(d=l.position().top),s(),o=$("#card"+a).position().top,i.addClass("active"),c(o),$(".currentRow").after(n(a)),d!=o?$("html, body").animate({scrollTop:$("#content"+a).offset().top-50},500):$("body").scrollTop(u)}}),a.on("click",".js-previous-content",function(e){var o,r=$(e.currentTarget).closest(".js-generated-content"),a=(0,t.default)(r.attr("data-id"))-1,i=$("#card"+a);if(i.length){var l=$(".card.active"),d=0,u=$("body").scrollTop();l.length&&(d=l.position().top),s(),o=$("#card"+a).position().top,i.addClass("active"),c(o),$(".currentRow").after(n(a)),d!=o?$("html, body").animate({scrollTop:$("#content"+a).offset().top-50},500):$("body").scrollTop(u)}});
},{"@babel/runtime-corejs3/core-js-stable/parse-int":"LSYy","@babel/runtime-corejs3/core-js-stable/instance/find":"CoUx"}],"fjED":[function(require,module,exports) {
...
},{}],"rhL8":[function(require,module,exports) {
"use strict";var e=t(require("@babel/runtime-corejs3/core-js-stable/instance/find"));function t(e){return e&&e.__esModule?e:{default:e}}require("./style5"),require("./style"),require("./style3"),require("./style4"),$(function(){$("#contact-form").validator(),$("#contact-form").on("submit",function(t){if(!t.isDefaultPrevented()){var s;return(0,e.default)(s=$("#contact-form")).call(s,".messages").html('<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Your message was sent, thank you. I will get back to you soon.</div>'),$("#contact-form")[0].reset(),!1}})});
},{"@babel/runtime-corejs3/core-js-stable/instance/find":"CoUx","./style5":"zkPG","./style":"FVon","./style3":"boJk","./style4":"fjED"}]},{},["rhL8"], null)
//# sourceMappingURL=main.08015bed.js.map