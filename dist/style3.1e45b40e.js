...
},{"../internals/global":"IJ8E","../internals/object-get-own-property-descriptor":"HtdO","../internals/is-forced":"Ohll","../internals/path":"iXvo","../internals/function-bind-context":"PPXG","../internals/create-non-enumerable-property":"yNEm","../internals/has":"mKeN"}],"gJF1":[function(require,module,exports) {
module.exports="\t\n\v\f\r                　\u2028\u2029\ufeff";
...
},{"core-js-pure/stable/parse-int":"MIil"}],"Nvz5":[function(require,module,exports) {
...
},{"core-js-pure/stable/instance/find":"ou1i"}],"boJk":[function(require,module,exports) {
"use strict";var o=e(require("@babel/runtime-corejs3/core-js-stable/parse-int")),t=e(require("@babel/runtime-corejs3/core-js-stable/instance/find"));function e(o){return o&&o.__esModule?o:{default:o}}var n=$(".js-card"),s=$(".js-card-grid");function r(o){var e=$("#card"+o);return'<div id="content'+o+'" data-id="'+o+'" class="more-container js-generated-content">'+(0,t.default)(e).call(e,".js-more-container").clone().html()+"</div>"}function i(o){var t=!1;n.each(function(){var e=$(this).position().top;if(e===o&&!1===t)n.removeClass("currentRow"),$(this).addClass("currentRow");else if(e>o&&!1===t)t=!0;else if(!0===t)return!1})}function a(){$(".js-generated-content").remove(),n.removeClass("active"),n.removeClass("currentRow")}function l(){$(".responsive").slick({dots:!0,prevArrow:$(".prev"),nextArrow:$(".next"),infinite:!1,speed:300,slidesToShow:4,slidesToScroll:4,responsive:[{breakpoint:1024,settings:{slidesToShow:2,slidesToScroll:2,infinite:!0,dots:!0}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]})}s.on("click",".js-card",function(o){var t=$(".card.active"),e=0,n=$("body").scrollTop();t.length&&(e=t.position().top),a();var s=$(o.currentTarget),l=s.attr("data-id"),d=s.position().top;s.addClass("active"),i(d),$(".currentRow").after(r(l)),e!=d?$("html, body").animate({scrollTop:$("#content"+l).offset().top-50},500):$("body").scrollTop(n)}),s.on("click",".js-close-content",function(o){a();var t=$(o.currentTarget).closest(".js-generated-content").attr("data-id");$("#card"+t).removeClass("lastClick"),$("html, body").animate({scrollTop:$("#card"+t).offset().top-50},500)}),s.on("click",".js-next-content",function(t){var e,n=$(t.currentTarget).closest(".js-generated-content"),s=(0,o.default)(n.attr("data-id"))+1,l=$("#card"+s);if(l.length){var d=$(".card.active"),c=0,v=$("body").scrollTop();d.length&&(c=d.position().top),a(),e=$("#card"+s).position().top,l.addClass("active"),i(e),$(".currentRow").after(r(s)),c!=e?$("html, body").animate({scrollTop:$("#content"+s).offset().top-50},500):$("body").scrollTop(v)}}),s.on("click",".js-previous-content",function(t){var e,n=$(t.currentTarget).closest(".js-generated-content"),s=(0,o.default)(n.attr("data-id"))-1,l=$("#card"+s);if(l.length){var d=$(".card.active"),c=0,v=$("body").scrollTop();d.length&&(c=d.position().top),a(),e=$("#card"+s).position().top,l.addClass("active"),i(e),$(".currentRow").after(r(s)),c!=e?$("html, body").animate({scrollTop:$("#content"+s).offset().top-50},500):$("body").scrollTop(v)}}),l(),$(".responsive").slick({dots:!0,prevArrow:$(".prev"),nextArrow:$(".next"),infinite:!1,speed:300,slidesToShow:4,slidesToScroll:4,responsive:[{breakpoint:1024,settings:{slidesToShow:2,slidesToScroll:2,infinite:!0,dots:!0}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]}),$(document).ready(function(){var o;$(".video-btn").click(function(){o=$(this).data("src"),console.log(o)}),console.log(o),$("#vModal-1").on("shown.bs.modal",function(t){$("#video-1").attr("src",o+"?rel=0&showinfo=0&modestbranding=1&autoplay=1")}),$("#vModal-1").on("hide.bs.modal",function(t){$("#video-1").attr("src",o)}),$("#vModal-2").on("shown.bs.modal",function(t){$("#video-2").attr("src",o+"?rel=0&showinfo=0&modestbranding=1&autoplay=1")}),$("#vModal-2").on("hide.bs.modal",function(t){$("#video-2").attr("src",o)}),$("#vModal-3").on("shown.bs.modal",function(t){$("#video-3").attr("src",o+"?rel=0&showinfo=0&modestbranding=1&autoplay=1")}),$("#vModal-3").on("hide.bs.modal",function(t){$("#video-3").attr("src",o)}),$("#vModal-4").on("shown.bs.modal",function(t){$("#video-4").attr("src",o+"?rel=0&showinfo=0&modestbranding=1&autoplay=1")}),$("#vModal-4").on("hide.bs.modal",function(t){$("#video-4").attr("src",o)}),$("#vModal-4").on("shown.bs.modal",function(t){$("#video-5").attr("src",o+"?rel=0&showinfo=0&modestbranding=1&autoplay=1")}),$("#vModal-5").on("hide.bs.modal",function(t){$("#video-5").attr("src",o)}),$("#vModal-6").on("shown.bs.modal",function(t){$("#video-6").attr("src",o+"?rel=0&showinfo=0&modestbranding=1&autoplay=1")}),$("#vModal-6").on("hide.bs.modal",function(t){$("#video-6").attr("src",o)})});
},{"@babel/runtime-corejs3/core-js-stable/parse-int":"LSYy","@babel/runtime-corejs3/core-js-stable/instance/find":"CoUx"}]},{},["boJk"], null)
//# sourceMappingURL=style3.1e45b40e.js.map